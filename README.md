```
Usage:
  bin/simple-debit [-o|--output=<Str>] [--base-uri=<Str>] [--retry[=UInt]] [--retry-on-client-error] [-v]
  bin/simple-debit [-o|--output=<Str>] [--base-uri=<Str>] [--retry[=UInt]] [--retry-on-client-error] [-v] [<ids> ...]
